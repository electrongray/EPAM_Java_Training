...
public class ShelfGeneratorEnglish {
    private static String[] bookNames = {"Pride and Prejudice", "Jane Eyre",
            "Animal Farm", "The Picture of Dorian Gray", "Hamlet",
            "Great Expectations"};
    private static String[] authors = {"Jane Austen", "Charlotte Bronte",
            "George Orwell", "Oscar Wilde", "Charles Dickens",
            "William Shakespeare"};
    private static String[] publishingHouses = {"Pearson", "McGraw-Hill " +
            "Education", "Oxford University Press", "Prentice Hall",
    ...
    public static Book[] createShelf(int quantity){
        ...
        for(int i = 0; i < quantity; i++){
            ...
            shelf[i] = new Book(bookName, author, publishingHouse, year, pages,
                    price);
        }
