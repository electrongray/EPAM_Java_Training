...
public class ShelfGenerator {
    ...
    private String[] bookNames = {"Нова экспресс", "Аллея Торнадо",
            "Серебрянная ложка", "Цветок в пустыне", "Фриленды",
            "На Форсайтской Бирже", "Вилла Рубейн",
            "Изюминка"};
    private String[] authors = {"Барбюс Анри", "Берроуз Вильям",
            "Берроуз Эдгар Райс", "Борхес Хорхе Луис", "Буковски Чарльз",
            "Дю Гар Роже Мартен", "Голдсмит Оливер", "Голсуорси Джон",
            "Диккенс Чарльз"};
    private String[] publishingHouses = {"Pearson", "McGraw-Hill Education",
    ...
    public Book[] createShelf(int quantity){
        ...
        for(int i = 0; i < quantity; i++){
            ...
            publishingHouse = publishingHouses[random.nextInt
                    (publishingHouses.length - 1)];
            ...
            shelf[i] = new Book(bookName, author, publishingHouse, year,
                    pages, price);
        }
